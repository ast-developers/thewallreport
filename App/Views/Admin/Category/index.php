...
<div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="row">
            <div class="pull-left">
                <form action="<?php echo \App\Config::W_ROOT . "admin/addcategory" ?>" method="post" class="category-form form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" name="name" placeholder="name" class="m-wrap medium" value="<?php echo $name; ?>" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-icon left">
                            <input type="text" name="slug" placeholder="slug" class="m-wrap medium" value="<?php echo $slug; ?>" />
                             </div>
                        </div>
                    </div>
                        ...
                        <div class="controls">
                            <select class="medium m-wrap" name="parent_id" tabindex="1">
                                ...
                                <?php foreach($parent_cat as $option){ ?>
                                    <option value="<?php echo $option['4'] ?>" <?php echo (!empty($category['parent_id']) && $category['parent_id'] == $option['4']) ? 'selected="selected"' : ''; ?>><?php echo $option['1'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
            ...
            <div class="span6 responsive pull-right" data-tablet="span12 fix-offset" data-desktop="span6">
