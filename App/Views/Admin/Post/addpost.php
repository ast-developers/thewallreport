...
<div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <!-- BEGIN PAGE CONTENT-->
        <div class="row-fluid">
            <form action="<?php echo \App\Config::W_ROOT . 'admin/add-post' ?>" method="post" enctype="multipart/form-data"
                  class="post-form">
                    ...
                    <div class="tab-pane">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <?php $views = (isset($post['views'])) ? $post['views'] : '' ?>
                                <div class="control-group">
                                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="span6 m-wrap" multiple="multiple" name="category_id[]" id="category"
