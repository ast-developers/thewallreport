var Page = function () {
    ...
    return {
        ...
        initList: function () {
            App.init();
            initPageDataTable();
            App.initBulkDelete({'deleteElement': $('#deletePages'), 'deleteUrl': pageBulkDeleteUrl, 'deleteSuccessMsg': 'Pages deleted successfully.', 'dataTable': dataTable});
        },
