...
class FFFeedsTab implements LATab{
	...
	public function includeOnce( $context ) {
		$arr = $context['feeds'];
		?>
		<div class="section-content" id="feeds-cont" data-tab="feeds-tab">
			<div class="section" id="feeds-list" data-view-mode="streams-list">

				<div class="section" id="streams-list-section">
					<h1 class="desc-following"><span>List of your Feeds</span> <span class="admin-button green-button button-add">Add stream</span></h1>
