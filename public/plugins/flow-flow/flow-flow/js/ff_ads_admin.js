...
//          return  date.valueOf() <= start.date.valueOf()  ? 'disabled' : '';
    ...
    addElement: function () {
      ...
      setTimeout(function(){
        ...
        function addElementToDom(type){
          var html = templates.elementTemplate[type].replace('<%= url %>', window.plugin_url.replace('flow-flow', 'flow-flow'));
    ...
    cloneElement: function(e) {
      ...
      clonedModel.views = clonedModel.clicks = clonedModel.conversion = 0;
